...
export const getPermitHandler = async (req : Request , res : Response , next : NextFunction) =>{
...
export const deletPermitHandler = async (req : Request , res : Response , next : NextFunction ) =>{
