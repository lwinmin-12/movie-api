...
export const deleteAllUserHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const userAddWatchLaterHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  let foundRole = user[0].watchLater.find(
    (ea: any) => ea._id == req.body.videoId
  );
  if (foundRole) {
...
export const userRemoveWatchLaterHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const userRemoveHistoryHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
